...
const emptyForm = { company: "", title: "", description: "", qualifications: "", experience_level: "", deadline: "", form_link: "", status: "Open", image_url: "", audio_url: "", platform_link: "" };
...
export default function AdminJobs() {
  ...
  const handleSave = async () => {
    if (!form.company.trim() || !form.title.trim()) {
      window.alert("Company and title are required.");
      return;
    }
  ...
  const handleDelete = (id: number) => {
    if (window.confirm("Delete this job?")) remove.mutate(id);
  };
  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        <h2 style={{ fontSize: 18, fontWeight: 600, color: "hsl(0,0%,20%)" }}>Jobs</h2>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 12, flexWrap: "wrap" }}>
        <input
          ...
          style={{ ...inputStyle, height: 32, maxWidth: 280, borderRadius: 0 }}
        />
        <select
          value={levelFilter}
              ...
              {isLoading ? (
                ...
                jobs.map((row) => (
                  <tr key={row.id}>
                    ...
                    <td>
                      <div style={{ fontSize: 12, padding: "0 4px" }}>{row.experience_level || "—"}</div>
                    </td>
                    <td>
        ...
        >
          <div style={{
            ...
            <div style={{ flex: 1, overflowY: "auto", padding: "20px 24px" }}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <div>
                  ...
                  <input value={form.company} onChange={(e) => setForm((prev) => ({ ...prev, company: e.target.value }))} style={inputStyle} />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select value={form.experience_level} onChange={(e) => setForm((prev) => ({ ...prev, experience_level: e.target.value }))} style={inputStyle}>
              ...
              <div style={{ marginTop: 16 }}>
                ...
                <div style={{ border: "1px solid #d4d7dd", borderRadius: 6, overflow: "hidden" }}>
                  <ReactQuill
                    ...
                    onChange={(val) => setForm((prev) => ({ ...prev, qualifications: val }))}
                    modules={quillModules}
                    formats={quillFormats}
                    style={{ backgroundColor: "#fff" }}
                  />
            ...
            <div style={{
              ...
              >
                {isSaving ? "Saving..." : editingId ? "Update Job" : "Create Job"}
              </button>
            </div>
          </div>
        </div>
